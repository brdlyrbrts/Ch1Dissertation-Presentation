...
Include stakeholders in the earliest phases of predictive analytics development (Cohen et al., 2014)
...
<font color=#fcc30f>1.</font> Evaluate word embeddings to determine an appropriate model that captures semantic (i.e., meaning) and syntactic (i.e., grammatical) content of the patient note for downstream applications.  

<br />

<font color=#fcc30f>2.</font> Examine the current subject matter and structure of patient notes to disseminate the level of information related to patient care. 

<br />

<font color=#fcc30f>3.</font> Identify ways that physicians can be incorporated into the design process of clinical support systems for health care including applications in artificial intelligence.
...
based on measures such as success rate, time-to-completion, and decision-making accuracy (Mishra et al., 2014).

<br />

- No domain-specific (chronic pain) datasets for evaluation exist
...
Mishra, R., Bian, J., Fiszman, M., Weir, C. R., Jonnalagadda, S., Mostafa, J., & Fiol, G. D. (2014). Text Summarization in the Biomedical Domain: A Systematic Review of Recent Research. Journal of Biomedical Informatics, 0, 457–467. http://doi.org/10.1016/j.jbi.2014.06.009

Wachter, R. (2012). The Digital Doctor: Hope, Hype, and Harm at the Dawn of Medicine’s Computer Age. [Kindle DX version]. Retrieved from Amazon.com.
